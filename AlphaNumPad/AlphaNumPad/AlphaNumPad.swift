...
//
//
//  AlphaNumPad by Akito on 2021/3/15.
//
...
extension UITextField{
    func setupAlphaNumPad(){
        let alphaNumPad = AlphaNumPad()
        alphaNumPad.delegate = self
        inputView = alphaNumPad
    }
}
///字母键盘
class AlphaNumPad: UIView{
